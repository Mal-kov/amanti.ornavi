...
<div class="notice notice-error is-dismissible">
	...
	<?php printf( esc_html__( '%1$sUnable to install the GeoIP database.%2$s You have to install it manually: %3$sHow to install the GeoIP database?%4$s', 'wc-price-based-country' ), '<strong>', '</strong>', '<a target="_blank" rel="noopener noreferrer" href="https://www.pricebasedcountry.com/docs/common-issues/the-maxmind-geoip-database-does-not-exist/?utm_source=geoipdb-notice&utm_medium=banner&utm_campaign=Docs">', '</a>' ); ?></p>
</div>
