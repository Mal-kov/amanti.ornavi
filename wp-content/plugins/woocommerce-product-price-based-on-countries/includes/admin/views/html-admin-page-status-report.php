...
<thead>
	...
	<tbody id="wcpbc-geolocation-debug">
		<tr>
			<td data-export-label="Default customer location"><?php esc_html_e( 'Default customer location', 'wc-price-based-country' ); ?>:</td>
			<td class="help">&nbsp;</td>
			<td><?php echo esc_html( get_option( 'woocommerce_default_customer_address' ) ); ?></td>
		</tr>
		<tr>
			<td data-export-label="MaxMind GeoIP database"><?php esc_html_e( 'MaxMind GeoIP database', 'wc-price-based-country' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( __( 'The GeoIP database from MaxMind is used to geolocate customers.', 'wc-price-based-country' ) ); ?></td>
			<td>
			<?php
			if ( wcpbc_geoipdb_exists() ) {
				echo '<mark class="yes"><span class="dashicons dashicons-yes"></span></mark>';
			} else {
				echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . esc_html__( 'The MaxMind GeoIP Database does not exist - Geolocation will not function.', 'wc-price-based-country' ) . '</mark>';
			}
			?>
			</td>
		</tr>
		...
		<tr>
			<td data-export-label="MaxMind GeoIP license"><?php esc_html_e( 'MaxMind license', 'wc-price-based-country' ); ?>:</td>
			<td class="help"><?php echo wc_help_tip( __( 'The key that will be used when dealing with MaxMind Geolocation services.', 'wc-price-based-country' ) ); ?></td>
			<td>
			<?php
		...
		<?php endforeach; ?>
		<tr>
			<td data-export-label="Real external IP"><?php esc_html_e( 'Real external IP', 'wc-price-based-country' ); ?>:</td>
			<td class="help">&nbsp;</td>
