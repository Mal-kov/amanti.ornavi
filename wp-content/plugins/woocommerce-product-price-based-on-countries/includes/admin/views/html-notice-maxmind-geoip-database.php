...
<div class="notice notice-error notice-pbc pbc-is-dismissible">
	...
	<?php printf( esc_html__( 'The MaxMind GeoIP Database does not exist, geolocation will not work. %1$sClick here to install the MaxMind GeoIP Database now%2$s.', 'wc-price-based-country' ), '<a href="' . esc_url( add_query_arg( 'wcpbc_update_geoip_database', wp_create_nonce( 'wcpbc-update-geoipdb' ) ) ) . '">', '</a>' ); ?></p>
</div>
